...
const FloatingButtons = () => {
  ...
  // Debug: Esto nos dirá en la consola si el componente se está cargando
  useEffect(() => {
    console.log("FloatingButtons: El componente se montó correctamente.");
  }, []);
  ...
  const btnStyle = {
    ...
    cursor: 'pointer',
    color: 'white',
    textDecoration: 'none' // Importante para que no parezca un link azul
  };
  ...
  return (
    <div style={{
      ...
      bottom: '20px',
      right: '20px',
      zIndex: 2147483647, /* El valor máximo posible en CSS para asegurar que nada lo tape */
      display: 'flex',
