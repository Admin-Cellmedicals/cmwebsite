...
const FloatingButtons = () => {
  ...
  const registrarClick = async (redSocial) => {
    // Validación de seguridad: Si la DB no cargó, no rompe la app, solo avisa en consola
    if (!db) {
    ...
    try {
      ...
      console.error("Error al registrar click (pero el usuario fue redirigido igual): ", e);
    }
  };
