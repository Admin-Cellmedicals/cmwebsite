...
const FloatingButtons = () => {
  ...
  return (
    <div style={{
      ...
      {/* --- BOTÓN INSTAGRAM CORREGIDO (USANDO SVG) --- */}
      <a 
        href={instagramUrl}
        target="_blank"
        ...
        style={{
          ...btnStyle,
          // Gradiente oficial de Instagram como fondo
          background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)'
        }}
        onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'}
        onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}
      >
        {/* Usamos un SVG inline para control total del color */}
        <svg 
          xmlns="http://www.w3.org/2000/svg" 
          width="35" 
          height="35" 
          viewBox="0 0 24 24" 
          fill="white" // <-- ¡ESTO ES LA CLAVE! Relleno blanco directo
        >
